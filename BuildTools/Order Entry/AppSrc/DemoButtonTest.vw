...
Object oButtonTest is a dbView
    ...
    Object oTextAndImageBottomButtonNS16 is a Button
        Set Size to 26 68
        Set Location to 59 10
        Set Label to "Non scaled (16)"
        Set psImage to "all.ico"
        Set peImageAlign to Button_ImageList_Align_Bottom
        Set piImageMarginBottom to 10
        Set pbAutoResizeIcons to False
    ...
    Object oTextAndImageBottomButtonS is a Button
        Set Size to 26 68
        Set Location to 59 80
        Set Label to "Scaled (16)"
        Set psImage to "all.ico"
        Set peImageAlign to Button_ImageList_Align_Bottom
        Set piImageMarginBottom to 10
    ...
    Object oTextAndImageBottomButton is a Button
        Set Size to 26 68
        Set Location to 59 150
        Set Label to "Non scaled (24)"
        Set psImage to "all.ico"
        Set peImageAlign to Button_ImageList_Align_Bottom
        Set piImageMarginBottom to 10
    ...
    Object oTextAndImageBottomButton is a Button
        Set Size to 26 68
        Set Location to 59 220
        Set Label to "Scaled (24)"
        Set psImage to "all.ico"
        Set peImageAlign to Button_ImageList_Align_Bottom
        Set piImageMarginBottom to 10
        Set piImageSize to 24
    ...
    Object oTextBox1 is a TextBox
        ...
        Set Label to 'Buttons Using DPI Scaling'
    End_Object
